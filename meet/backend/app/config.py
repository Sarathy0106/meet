...
class Settings(BaseSettings):
    ...
    # Internal Service Key (for Calendar <-> Meet communication)
    INTERNAL_SERVICE_KEY: str = Field(default="sidaz_internal_secret_key_meet_calendar_2026")
    CALENDAR_API_URL: Optional[str] = Field(default="http://localhost:8001")
    FRONTEND_URL: str = Field(default="https://frontend-seven-theta-86.vercel.app")

    # CORS Origins
    CORS_ORIGINS: Union[str, List[str]] = Field(
        default="http://localhost:5173,http://localhost:5174,http://localhost:3000,http://127.0.0.1:5173,https://frontend-seven-theta-86.vercel.app,https://frontend-q9uk0z0p4-sarathys-projects-d5b7e797.vercel.app"
    )
